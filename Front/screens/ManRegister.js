...
import { createManager } from "../components/Authenticate";
import { AuthContext } from "../components/AuthContext";
import { useContext } from "react";

function ManRegister(props){
    ...
    async function handleSubmit(){
        ...
        if(username!="" && confPassword == password && fname != "" && lname!="" && phoneNum!=0 && address!=""){
            ...
            try{
                const data = await createManager(username, fname, lname, password, address, phoneNum);
